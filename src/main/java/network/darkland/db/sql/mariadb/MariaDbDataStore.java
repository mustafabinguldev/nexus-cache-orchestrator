...
/**
 * MariaDB {@link DataStore}. Pure composition, no logic of its own: connection lifecycle
 * lives in {@link SqlConnectionManager}, query/write logic lives in {@link SqlRepository},
 * MariaDB-specific SQL lives in {@link MariaDbDialect}.
 */
public final class MariaDbDataStore implements DataStore {

    private final SqlConnectionManager connectionManager;
    private final SqlRepository repository;

    public MariaDbDataStore(String host, int port, String database, String username, String password,
        ...
        this.connectionManager = new SqlConnectionManager(
                ...
                dialect.driverClassName(), "Nexus-MariaDB-Pool");
